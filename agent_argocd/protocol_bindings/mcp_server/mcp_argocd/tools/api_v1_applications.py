...
async def application_service__create(param_upsert: str = None, param_validate: str = None) -> Dict[str, Any]:
    '''
    Creates an application using the provided parameters.

    Args:
        param_upsert (str, optional): Specifies whether to upsert the application. Defaults to None.
        param_validate (str, optional): Indicates whether to validate the application data. Defaults to None.

    Returns:
        Dict[str, Any]: The JSON response from the API call, containing the application details or error information.
